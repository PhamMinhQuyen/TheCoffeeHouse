...
import com.example.doancanhan.CH_UuDai_User.List_UuDai_User;
import com.example.doancanhan.R;

import java.util.List;

public class CH_UuDai_User_Adapter   extends BaseAdapter {
    Context context;
    int Layout;
    List<List_UuDai_User> arrayList;

    public CH_UuDai_User_Adapter(Context context, int layout, List<List_UuDai_User> arrayList) {
